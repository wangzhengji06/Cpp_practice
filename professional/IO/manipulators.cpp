...
int main() {
  ...
  cout << "This should be a money amount of 120000, "
       << "formatted according to your location: " << put_money("120000")
       << endl;
...
// C4996: 'std::localtime': This function or variable may be unsafe. Consider
...
#pragma warning(disable : 4996)
  ...
  cout << "This should be the current date and time "
       << "formatted according to your location: " << put_time(&t, "%c")
       << endl;
